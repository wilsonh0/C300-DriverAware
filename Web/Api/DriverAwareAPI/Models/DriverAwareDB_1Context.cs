...
namespace DriverAwareAPI.Models
{
    ...
    public partial class DriverAwareDB_1Context : DbContext
    {
        ...
        public DbSet<DriverAwareAPI.Models.RecordedIncident> RecordedIncident { get; set; }
        public DbSet<DriverAwareAPI.Models.Driver> Driver { get; set; }
        public DbSet<DriverAwareAPI.Models.Shift> Shift { get; set; }
        public DbSet<DriverAwareAPI.Models.Vehicle> Vehicle { get; set; }
        public DbSet<DriverAwareAPI.Models.Company> Company { get; set; }
        public DbSet<DriverAwareAPI.Models.UserLogIn> UserLogIn { get; set; }
